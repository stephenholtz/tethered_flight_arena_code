% Make patterns for the chasing incedence optimization Makes 4 - 8 - 12 (24
% - 48) pixel width stripes in the y channels that fill up only the center
% of the arena. Rotation in the x channel
    ...
    str = [directory_name '\Pattern_03_4_8_12_pix_wide_middle_arena_stripes'];
    save(str, 'pattern');