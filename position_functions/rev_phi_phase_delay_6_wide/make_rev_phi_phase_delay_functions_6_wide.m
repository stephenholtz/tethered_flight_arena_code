function make_rev_phi_phase_delay_functions_6_wide
%% info
...
project = 'rev_phi_phase_delay_6_wide';
temporal_freqs = [.25 .5 1.25 2];    % the .5 is set below to show up as 0pt5
...
%% Make the functions
for pattern_x_length = 12; % the wavelength of the function (1/sf)
