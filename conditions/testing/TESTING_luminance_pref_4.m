function [Conditions conds_matrix symPairs] = TESTING_luminance_pref_4
% gain of -2, 2 widths (11.25 deg and 22.5 deg)
cond_num = 1;
% 11 = 3 pix, 31 = 6 px;
...
Conditions(cond_num).Gains = [-2 0 0 0];
...
Conditions(i).RewardConditions.Gains = [-2 0 0 0];
