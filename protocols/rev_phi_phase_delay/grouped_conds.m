...
grouped_conditions.set{1}.name = '0.5 Hz';
grouped_conditions.set{1}.x_axis = [-62.5 -55 -45 -37.5 -27.5 -20 -10 -2.5 0 0 2.5 20 27.5 37.5 45 55 62.5];
grouped_conditions.set{1}.list = ...
                       {[18,36];... %
                        [17,35];... % 
                        [16,34];... % 
                        [15,33];... % 
...
grouped_conditions.set{2}.name = '1 Hz';
grouped_conditions.set{2}.x_axis = [-30 -25 -22.5 -17.5 -15 -10 -7.5 -2.5 0 0 2.5 7.5 10 15 17.5 22.5 25 30];
grouped_conditions.set{2}.list = ...
                       {[54,72];... %
                        [53,71];... %                        
                        [52,70];... %
                        [51,69];... %
...
grouped_conditions.set{3}.name = '2 Hz';
grouped_conditions.set{3}.x_axis = [-15 -12 -10 -7.5  -5 -2.5 0 0 2.5 7.5 10 12 15];
grouped_conditions.set{3}.list = ...
                       {[86,100];...%
                        [85,99];... %
                        [84,98];... %
                        [83,97];... %
...
grouped_conditions.set{4}.name = '3 Hz';
grouped_conditions.set{4}.x_axis = [-10 -7.5 -5 -2.5 0 0 2.5 5 7.5 10];
grouped_conditions.set{4}.list = ...
                       {[110,120];...%  
                        [109,119];... %  
                        [108,118];... % 
