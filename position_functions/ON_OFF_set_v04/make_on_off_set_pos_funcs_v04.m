...
output_location = '/Users/stephenholtz/tethered_flight_arena_code/position_functions/ON_OFF_set_v04';
func_iter = 1;
...
time_before_set    = [50  50];
time_between_1_set = [100 200];
time_between_2_set = [100 200];
time_after = 500;

% for time_before = time_before_set
%     for time_between_1 = time_between_1_set
%         for time_between_2 = time_between_2_set
    for i = 1:2
        
        time_before = time_before_set(i);
        time_between_1 = time_between_1_set(i);
        time_between_2 = time_between_2_set(i);
