    ...
    for et_1 = {'on','off'}
        ...
        for et_2 = {'on','off'}
            ...
            for dir = {'cw','ccw'}
                ...
                start_cols = 0:8:88;
                jump_size = 2;
                bar_factory.MinimalMotion(bar_size,start_cols,direction,edge_type_1,edge_type_2);
                bar_factory.AddDummyFrames('x',1);
                Pats(:,:,:,:) = bar_factory.ReturnPatternAndParams;

                pattern_name = [edge_type_1 '_to_' edge_type_2 '_minimal_motion_stim_step_' num2str(jump_size) '_' direction '_bar_sz_' num2str(bar_size) '_w_dummy_x_frame'];
...
pattern_name = ['ON_OFF_looping_bar_CW_' num2str(bar_size) 'wide_w_dummy_x_frame'];
...
pattern_name = ['ON_OFF_looping_bar_CCW_' num2str(bar_size) 'wide_w_dummy_x_frame'];
