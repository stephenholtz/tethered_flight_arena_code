...
pattern.x_num = 96*4; 	% 12 frames before repeat 
...
for j = 1:length(flicker_offsets)
    ...
    for ko = [48 48+96 48+96*2 48+96*3]
        flick = ko-flicker_offsets(j):ko+47-flicker_offsets(j);
        flicks = [flicks flick];
    end
...
name =  'Pattern_007_1111_phasediffs_384_4wide_before_rotation';
