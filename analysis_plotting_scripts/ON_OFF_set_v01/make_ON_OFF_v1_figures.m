...
data_location = '/Users/stephenholtz/local_experiment_copies/ON_OFF_set_v01';
...
if 0
    ...
    for cn = {'min_mot_ON_44','min_mot_OFF_44','min_mot_ON_76','min_mot_OFF_76','min_mot_ON_116','min_mot_OFF_116'}
        ...
        for row = 1:5
            ...
            graph.variance{i}   = std(tuning_curves.butter_offset.(curve_name)(i).ts{row});
...
if 0
    ...
    for cn = {'on_off_edges_rear','on_off_edges_center'}
...
%             graph.avg{i}        = tuning_curves.(curve_name)(i).avg_ts{row};
%             graph.variance{i}   = tuning_curves.(curve_name)(i).sem_ts{row};
%             graph.color{i}      = my_colormap{i};
%             
%             tfPlot.timeseries(graph);
            ...
            plot((tuning_curves.(curve_name)(i).all_x_avg_ts{row})')
