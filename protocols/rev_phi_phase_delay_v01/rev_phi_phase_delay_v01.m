function Conditions = rev_phi_phase_delay_v01
...
for pat = [2 4]; % 8 Wide, full field, 8 Wide front field (front 120 degres)
    ...
    % loop condition       
        ...
        for flick = 1:2; % for both before and after the movement
            if flick == 1;
                ...
                switch pos_funcX
                    ...
                    case {20, 21} % tf 1
                        delay_funcs_y = [22 24:2:34]; % []           
                    case {35, 36} % tf 2
                        delay_funcs_y = [37 39:2:43]; % []           
                    case {44, 45} % tf 3
                        delay_funcs_y = [46 48:2:50]; % []           
                end
            end
        ...
        for pos_funcY = delay_funcs_y; % temporal freq sepecific delays pos function numbers
            ...
            Conditions(cond_num).Duration = 2.15;
