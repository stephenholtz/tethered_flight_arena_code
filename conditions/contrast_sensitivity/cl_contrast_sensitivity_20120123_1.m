function [Conditions conds_matrix symPairs patDir] = cl_contrast_sensitivity_20120123_1
% flight_arena_experiment('cl_contrast_sensitivity_20120123_1',3)
% for getting the missing conditions of the previous iterations (three
% equal stripes needed for a few conditions)
% pat1 y = 30 for gs_12 equal
% pat2 y = 30 for gs_5 eqal
% pat1 y = 26 for stripe fix baseline

cond_num = 1;
pats = 1:2; %:5;
ychans = [26 30]; %[26 27 29]; % 1,2-1,3
