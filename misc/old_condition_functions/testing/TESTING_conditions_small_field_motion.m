function [Conditions conds_matrix] = TESTING_conditions_small_field_motion
...
for i = 1:6 % 3 Posfunc/Pattern Combos
        if i == 5|| i ==6; Conditions(cond_num).PatternID = 1;    %#ok<*AGROW>
                   Conditions(cond_num).InitialPosition = [1 1];
        else       Conditions(cond_num).PatternID = 3;
        ...
        if      i == 1; Conditions(cond_num).Duration = 12.4;
                        Conditions(cond_num).PosFunctionX = [1 7];
        elseif  i == 2; Conditions(cond_num).Duration = 12.4;
                        Conditions(cond_num).PosFunctionX = [1 8];
        elseif  i == 3; Conditions(cond_num).Duration = 14.1;
                        Conditions(cond_num).PosFunctionX = [1 16];            
        elseif  i == 4; Conditions(cond_num).Duration = 14.1;
                        Conditions(cond_num).PosFunctionX = [1 17];  
        elseif  i == 5; Conditions(cond_num).Duration = 15.4;
                        Conditions(cond_num).PosFunctionX = [1 22];  
        elseif  i == 6; Conditions(cond_num).Duration = 15.4;
                        Conditions(cond_num).PosFunctionX = [1 23];  
        end
