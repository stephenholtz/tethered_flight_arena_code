...
bck = 15;   %0
b1 = 0;     %100.0 -- highest possible 
b2 = 12;    %11.11 -- pretty low
b3 = 14;    %03.45 -- lowest possible
...
% outside b1 -- inside b2
Pats(:,:,1,yset(5)) = [b1*ones(4,pxSize) bck*ones(4,gap) b2*ones(4,pxSize) bck*ones(4,gap) b1*ones(4,pxSize) bck*ones(4,gap)];
...
str = [directory_name '\Pattern_04_low_contrast_cl_choice_dark_on_light'];
save(str, 'pattern');
