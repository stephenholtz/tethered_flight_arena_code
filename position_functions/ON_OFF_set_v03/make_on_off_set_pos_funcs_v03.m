...
output_location = '/Users/stephenholtz/tethered_flight_arena_code/position_functions/ON_OFF_set_v03';
func_iter = 1;
...
time_before_set    = [40 80];
time_between_1_set = [50 100];
time_between_2_set = [80 160];
time_after = 500;
