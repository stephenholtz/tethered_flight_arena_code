...
% Make equally spaced horizontal stripes. UP/DOWN in the X, widths in Y.
    ...
    aPats = [];
    y = 0;
    for components = {{4 -2}, {8 -16},  {12 18}, {24 18}}
        size = components{1}{1};
        offset = components{1}{2};
        y = y+1;
        ...
        for g = 2:pattern.x_num;
            Pats(1:40,1:192,g,y) = circshift(tPats(1:40,1:192),g);
        end
    ...
    str = [directory_name 'Pat_02_horizontal_stripes_4_8_12'];
    save(str, 'pattern');