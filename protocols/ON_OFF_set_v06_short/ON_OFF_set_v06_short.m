function [Conditions] = ON_OFF_set_v06_short
...
% 
% THIS VERSION IS SHORTER THAN v06 BECAUSE IT IS MISSING EDGES + STEADY
% STATE STIMULI
%
% SLH - 2013
...
% Minimal Motion stimuli - is not included here
...
% % ON and OFF Edges
% for dps = round([60 120]/3.75) % 78 and 234 dps of the bar
...
%             Conditions(cond_num).Duration       = 96/dps;
%             Conditions(cond_num).note           = '';
% 
%             total_ol_dur = total_ol_dur + Conditions(cond_num).Duration + .1;
%             cond_num = cond_num + 1;
%         end
%     end
% end
