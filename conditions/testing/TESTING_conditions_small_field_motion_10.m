function [Conditions conds_matrix] = TESTING_conditions_small_field_motion_10
...
%for i = 33:34 % 3 Posfunc/Pattern Combos
 for i = 1:35 % 3 Posfunc/Pattern Combos
        ...
        if      i < 23
        Conditions(cond_num).Duration = 0.060;
        Conditions(cond_num).FuncFreqX = 150;
        elseif  i < 33;
        Conditions(cond_num).Duration = 0.805;
        Conditions(cond_num).FuncFreqX = 150;
        elseif  i < 35;
        Conditions(cond_num).Duration = 1.265;
        Conditions(cond_num).FuncFreqX = 150;        
        end
