function [Conditions conds_matrix symPairs patDir] = TESTING_contrast_sensitivity_3
% wide field variant of others
cond_num = 1;
...
Conditions(cond_num).Gains = [45 0 0 0];
...
Conditions(cond_num).PosFunctionX = [0 0];
end
