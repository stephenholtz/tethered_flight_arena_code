...
directory_name = 'C:\tethered_flight_arena_code\patterns\contrast_sensitivity_patterns\20120123_2';
str = [directory_name '\Pattern_01_low_contrast_cl_choice_dark_on_light'];
save(str, 'pattern');
