function make_reverse_phi_double_check_v02_functions
%% info
...
project = 'reverse_phi_double_check_v02_functions'; % Determines the destination show up
temporal_freqs = [.75 2 4];      % Set of tf's to use, the .5 is set below to show up as 0pt5 when saved
verbose_flag = 0;               % will make an additional position function that has out of phase flicker and movement
sampling_rate = 200;            % 400 hz allows for 2.5ms precision in offsets
pattern_y_length = 2;           % on and off flicker for the rev phi
max_num_delays = 10;% 8;        % if -1 it will make all, and check that the completely out of phase position function works...
