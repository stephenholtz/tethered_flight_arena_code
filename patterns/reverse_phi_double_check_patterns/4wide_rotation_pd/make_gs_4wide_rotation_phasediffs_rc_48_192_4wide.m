...
flicker_offsets = [0 1 2 3 4 6 8 12];

pattern.x_num = 48*4; 	% 12 frames before repeat 
...
for j = 1:length(flicker_offsets)
    ...
    flick = ko-flicker_offsets(j):ko+23-flicker_offsets(j);
    flicks = [flicks flick];
    end
...
name =  'Pattern_005_111_phasediffs_192_4wide_before_rotation';
