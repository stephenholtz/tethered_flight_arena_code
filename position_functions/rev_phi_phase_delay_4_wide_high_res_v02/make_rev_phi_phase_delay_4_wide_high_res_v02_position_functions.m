function make_rev_phi_phase_delay_4_wide_high_res_v02_position_functions
%% info
...
project = 'rev_phi_phase_delay_4_wide_high_res_v02'; % Determines the destination show up
temporal_freqs = 2;             % Set of tf's to use, the .5 is set below to show up as 0pt5 when saved
