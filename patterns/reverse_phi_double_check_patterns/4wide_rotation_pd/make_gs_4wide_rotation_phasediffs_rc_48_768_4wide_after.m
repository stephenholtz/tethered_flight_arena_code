...
for j = 1:length(flicker_offsets)
    ...
    for ko = [96 96+192 96+192*2 96+192*3]
        % %     for ko = [48 48+96 48+96*2 48+96*3] %%for 384 frames
% %             for ko = [24 24+48 24+48*2 24+48*3] %%for 192 frames
...
name = 'Pattern_010_22222_phasediffs_768_4wide_after_rotation';
