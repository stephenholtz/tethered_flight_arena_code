function [Conditions conds_matrix] = TESTING_conditions_small_field_motion_3
...
for i = 1:2 % 3 Posfunc/Pattern Combos
        ...
        if      i == 1; Conditions(cond_num).Duration = 20.6;
                        Conditions(cond_num).PosFunctionX = [1 1];
                        Conditions(cond_num).InitialPosition = [1 7];
        elseif  i == 2; Conditions(cond_num).Duration = 20.6;
                        Conditions(cond_num).PosFunctionX = [1 2]; 
                        Conditions(cond_num).InitialPosition = [1 7];
%         elseif  i == 3; Conditions(cond_num).Duration = 20.6;
%                         Conditions(cond_num).PosFunctionX = [1 1];
%                         Conditions(cond_num).InitialPosition = [1 3];
%         elseif  i == 4; Conditions(cond_num).Duration = 20.6;
%                         Conditions(cond_num).PosFunctionX = [1 2]; 
%                         Conditions(cond_num).InitialPosition = [1 3];
        end
