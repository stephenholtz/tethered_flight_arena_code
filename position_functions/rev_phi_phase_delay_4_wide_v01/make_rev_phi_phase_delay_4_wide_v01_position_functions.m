function make_rev_phi_phase_delay_4_wide_v01_position_functions
%% info
...
project = 'rev_phi_phase_delay_4_wide_v01'; % Determines the destination show up
temporal_freqs = [1 2 3];       % Set of tf's to use, the .5 is set below to show up as 0pt5 when saved
