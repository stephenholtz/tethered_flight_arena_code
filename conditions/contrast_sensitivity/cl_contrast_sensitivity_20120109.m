function [Conditions conds_matrix symPairs patDir] = cl_contrast_sensitivity_20120109
...
% This iteration, somewhat optimized choice of stripes, start at 3
% different positions each, with the only 3 relevant stimuli -- patterns
% now have more contrast vs 20120105 conditions
% 
% 6 pix vs 4 & 8, dk bar on lt bck

cond_num = 1;

ychans = [26 27 29]; % 1,2-1,3
initial_positions = [17 49 81]; % 3 pos
% for dark on light
for y_pos = ychans
