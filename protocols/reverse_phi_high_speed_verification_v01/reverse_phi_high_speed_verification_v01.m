function Conditions = reverse_phi_high_speed_verification_v01
...
% gather some information
    ...
    pos_func_loc = fullfile(dir,'position_functions','reverse_phi_high_speed_verification_v01');
        ...
        for flick = 1:2; % for both before and after the movement
            if flick == 1;
                switch pos_funcX
                    ...
                    case {1, 2} % tf 1
                        delay_funcs_y = [3 6 34 68]; % [0 5 40 82.5 ms before]
                ...
                switch pos_funcX
                    ...
                    case {1, 2} % tf 1
                        delay_funcs_y = [7 35 69]; % [5 40 82.5 ms after]
                end
            end
