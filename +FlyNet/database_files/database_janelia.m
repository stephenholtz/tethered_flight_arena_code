...
properties
    ...
    dbCredentials
    jdbcPath = fullfile('C:','tethered_flight_arena_code','+Data','mysql-connector-java-5.1.13','mysql-connector-java-5.1.13-bin.jar');
end
...
% Create instance of object. Requires database credentials as input
    ...
    if nargin == 1
        ...
        disp('database credentials not provided');
    end
