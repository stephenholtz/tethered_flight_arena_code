function Conditions = short_rev_phi_phase_delay_6_wide
...
% gather some information
    ...
    pos_func_loc = fullfile(dir,'position_functions','rev_phi_phase_delay_6_wide');
...
for pat = 3; % 6 Wide, full field
    % the different temporal frequency position functions
    for pos_funcX = [1 2 20 21 39 40 58 59]; % [.25cc cw .5cc cw 1.25 cc cw 2cc cw]
