function RunGUI(condition_func,meta_file,varargin)
...
%   trial type
% - Have a minimal terminal mode


%% Make the (original) figure

% the gui property will  
gui.fig_handle = figure('name','Exp.RunGUI','numbertitle','off','tag','gSS07',...
    'menubar','none','position',[40 140 800 600],'resize','on','deletefcn',...
