...
if isfield(graph,'color')
    ...
    error('tfPlot.tuning_curve requires cell array field "color"')
end
...
for i = 1:numel(graph.avg)
    ...
    if sum(graph.variance{i}) == 0
        ...
        if ~graph.dot_compare
            ...
            errorbar(x_positions,graph.avg{1},graph.variance{1},...
                                    'Marker','o',...
                                    'MarkerFaceColor','none',...
                                    'MarkerSize',4,...
                                    'Color',graph.color{1},...
                                    'LineWidth',graph.line_width);
            handle = errorbar(x_positions,graph.avg{2},graph.variance{2},...
                                    'Marker','o',...
                                    'MarkerFaceColor','none',...
                                    'MarkerSize',4,...
                                    'Color',graph.color{2},...
