function [Conditions conds_matrix] = TESTING_conditions_small_field_motion_6
...
for i = 1:12 % 3 Posfunc/Pattern Combos
        ...
        if      i == 1; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3];
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 2; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3]; 
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 3; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3]; 
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 4; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3]; 
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 5; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3]; 
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 6; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 3]; 
        Conditions(cond_num).InitialPosition = [1 1];  
        elseif  i == 7; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4];
        Conditions(cond_num).InitialPosition = [4 1];  
        elseif  i == 8; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4]; 
        Conditions(cond_num).InitialPosition = [4 1];  
        elseif  i == 9; Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4]; 
        Conditions(cond_num).InitialPosition = [4 1];  
        elseif  i == 10;Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4]; 
        Conditions(cond_num).InitialPosition = [4 1];  
        elseif  i == 11;Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4]; 
        Conditions(cond_num).InitialPosition = [4 1];  
        elseif  i == 12;Conditions(cond_num).Duration = 0.200;
                        Conditions(cond_num).PosFunctionX = [1 4]; 
        Conditions(cond_num).InitialPosition = [4 1];  
        end
...
Conditions(q).RewardConditions.RewardDuration = 1.5;
Conditions(q).RewardConditions.PatternID = 1;
Conditions(q).RewardConditions.Modes = [1 0];
Conditions(q).RewardConditions.Gains = [-20 0 0 0];
Conditions(q).RewardConditions.InitialPosition = [49 1];
